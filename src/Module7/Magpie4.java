...
public class Magpie4 {
	...
	public String getResponse(String statement)	{
		...
		// add extra phrases
		else if (findKeyword(statement, "are you alive") >= 0) 
			response = "I am not alive. I am simply a program";

		else if (findKeyword(statement, "friend") >= 0 ||
				findKeyword(statement, "friends") >= 0)
			response = "Well, we are friends, aren't we?";

		else if (findKeyword(statement, "who") >= 0) {
			
			// check what the answer ends with
			if (findKeyword(statement, "are you") >= 3)
				response = "I am Magpie, a chatbot.";
			else if (findKeyword(statement, "made you") >= 3)
	 ...
	 * @param statement the user statement, assumed to contain "I like <statement>"
